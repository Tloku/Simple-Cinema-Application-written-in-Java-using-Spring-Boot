...
public class AddScheduleWindow extends JFrame {
    ...
    private JTextField beginningTimeTextField = new JTextField(16);
    private JLabel endingTimeLabel = new JLabel("Czas zakończenia");
    private JTextField endingTimeTextField = new JTextField(16);
    ...
    @Autowired
    public AddScheduleWindow(iHarmonogramService harmonogramService, @Value("${property.repertoireID:0}") int repertoireID){
    ...
    private void initComponents() {
        ...
        beginningTimeTextField.setText("HH:MM:SS");
        endingTimeTextField.setText("HH:MM:SS");
    ...
    private void addScheduleActionListener() {
        ...
        harmonogramService.addScheduleForMovie(beginTime, endTime, movieID, repertoireID, cinemaHallID);
        this.setVisible(false);
    }
